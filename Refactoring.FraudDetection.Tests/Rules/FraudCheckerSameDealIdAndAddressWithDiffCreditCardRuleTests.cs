...
{
    [TestClass]
    public class FraudCheckerSameDealIdAndAddressWithDiffCreditCardRuleTests
    {
        [TestMethod]
        public void IsFraudulent_SameDataWithDiffCreditCard_ThenIsFraudulent()
        {
            ...
            var rule = new FraudCheckerSameDealIdAndAddressWithDiffCreditCardRule().IsFraudulent(current, next);

            Assert.IsTrue(rule);
        }

        [TestMethod]
        public void IsFraudulent_SameDataWithDiffState_ThenIsNotFraudulent()
        {
            var current = new Order { DealId = 1, State = "XX", ZipCode = "11111", Street = "Street Something", City = "City", CreditCard = "1111222233334444", Email = "email@email.com", OrderId = 1 };
            var next = new Order { DealId = 1, State = "YY", ZipCode = "11111", Street = "Street Something", City = "City", CreditCard = "1111222233334444", Email = "email@email.com", OrderId = 1 };
        ...
        [TestMethod]
        public void IsFraudulent_WhenSameDataWithEqualCreditCard_ThenIsNotFraudulent()
        {
            var current = new Order { DealId = 1, State = "XX", ZipCode = "11111", Street = "Street Something", City = "City", CreditCard = "1111222233334444", Email = "email@email.com", OrderId = 1 };
